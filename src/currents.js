...
export const CURRENTS = [
  ...
  // NB: the world wraps east-west now (earth.js dxWrap/wrapX) and currentAt is
  // seam-aware, so a ribbon MAY cross +/-180; this one is kept east of the
  // dateline only by choice.
