...
export class Sky {
  ...
  update(t, latDeg, center) {
    ...
    this.sun.intensity = 1.5 * sol.dayness;
    ...
    this.hemi.intensity = 0.2 + 0.7 * sol.dayness;
    ...
    this.starMat.opacity = Math.max(0, sol.nightness - 0.25) * 1.33;
