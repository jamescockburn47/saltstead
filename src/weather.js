...
// Inshore the land steals the wind; past the headlands it fills in. Up to
// 1.9x the base wind in true blue water — stacked on the open-sea gait, this
// is what makes a crossing FEEL like flying, not just be short.
export function windProfile(coastDist, base) {
  return base * (1 + 0.9 * smooth01((coastDist - 600) / 2800));
}
