...
const FINDINGS = [
  ...
  ['FIXED — the ocean mesh no longer shows its edge from a high lens.',
    ...
    + 'outermost ring of vertices is now pushed out to 1400 m \u2014 just past the '
    + '1200 m far plane, so the rim is CLIPPED rather than seen \u2014 which turns the '
    + 'last band of quads into an apron for no new vertices, no new draw call and no '
    + 'new material. Stated plainly: the apron\u2019s first 264 m (356 to 620) is still '
    + 'partly visible and has no wave geometry of its own, only height interpolated '
    + 'between the rings under 47-100% fog.'
  ],
